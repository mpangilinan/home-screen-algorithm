...
public class EPGRecord {
    ...
    public static void main(String[] args) {
    	...
    	ListOfEPGRecords list = rest.getForObject("http://10.76.243.80/epg/seriesFutureShowings.pl?series=135933406", ListOfEPGRecords.class);  
    	List<EPGRecord> recs = new ArrayList<EPGRecord>();
    	recs = list.getEPGRecords();
    	System.out.println(recs);
    	for (EPGRecord r : recs)
    		System.out.println(new Date(r.getStart()));
